  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}> 
        ...
        <div className='flex flex-col gap-2 tex-sm font-ligh text-gray-700'>
          <p className='flex gap-2'>
            <input className='w-3' type="checkbox" onChange={toggleSubCategory} value={'Rings'}/>Rings
          </p>
          <p className='flex gap-2'>
            <input className='w-3' type="checkbox" onChange={toggleSubCategory} value={'Earrings'}/>Earrings
          </p>
          <p className='flex gap-2'>
            <input className='w-3' type="checkbox" onChange={toggleSubCategory} value={'BraceletsBangles'}/>Bracelets & Bangles
          </p>
          <p className='flex gap-2'>
            <input className='w-3' type="checkbox" onChange={toggleSubCategory} value={'NecklacesPendants'}/>Necklaces & Pendants
          </p>
        </div>
      </div>
      </div>
